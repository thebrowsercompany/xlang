...
struct metadata_type
{
    ...
    virtual void write_swift_generic_param_logical_type(writer& w) const = 0;
    virtual void write_swift_generic_param_abi_type(writer& w) const = 0;
    virtual void write_swift_abi_name(writer& w) const = 0;
...
struct element_type final : metadata_type
{
    ...
    virtual void write_swift_generic_param_logical_type(writer& w) const override;
    virtual void write_swift_generic_param_abi_type(writer& w) const override;
    virtual void write_swift_abi_name(writer& w) const override;

    virtual void write_swift_abi_param(writer& w) const override;
...
struct enum_type final : typedef_base
{
    ...
    void write_swift_definition(writer& w) const;
